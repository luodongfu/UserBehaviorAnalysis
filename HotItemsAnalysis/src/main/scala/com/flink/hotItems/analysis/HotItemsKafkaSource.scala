...
object HotItemsKafkaSource {
  def main(args: Array[String]): Unit = {
    ...
    val kafkaDataSource = env.addSource(new FlinkKafkaConsumer[String]("test",new SimpleStringSchema(),properties))
      .map(line => {
