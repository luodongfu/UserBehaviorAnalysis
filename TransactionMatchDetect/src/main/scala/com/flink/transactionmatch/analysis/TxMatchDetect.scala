...
object TxMatchDetect {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /**
     * matched=>> (OrderEvent(34729,pay,sd76f87d6,1558430844),ReceiptEvent(sd76f87d6,wechat,1558430847))
     * matched=>> (OrderEvent(34730,pay,3hu3k2432,1558430845),ReceiptEvent(3hu3k2432,alipay,1558430848))
     * unmatchedReceipts=>> ReceiptEvent(ewr342as4,wechat,1558430845)
     * unmatchedReceipts=>> ReceiptEvent(8fdsfae83,alipay,1558430850)
     * unmatchedReceipts=>> ReceiptEvent(32h3h4b4t,wechat,1558430852)
     */
